...
class InsertRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'purchase_order_kitchen_supplier_id' => 'required|integer',
            'purchase_order_kitchen_supplier_name' => 'required|string',
            'purchase_order_kitchen_pic_name' => 'required|string',
            'purchase_order_kitchen_pic_phone' => 'nullable|string',
