...
class VolunteerSalaryDt extends BaseModel
{
    ...
    public function getAllData($hdCode)
    {
        return DB::select(
            "SELECT
                ...
                isnull(volunteer_salary_dt_overtime, 0) as volunteer_salary_dt_overtime,
    ...
    public function insertData($params)
    {
        return DB::insert(
            ...
            volunteer_salary_dt_work_day, volunteer_salary_dt_price, volunteer_salary_dt_bonuses, volunteer_salary_dt_overtime, volunteer_salary_dt_total)
            VALUES
            (:volunteer_salary_hd_code, :volunteer_salary_dt_user_code, :volunteer_salary_dt_user_name, :volunteer_salary_dt_divisi,
            :volunteer_salary_dt_work_day, :volunteer_salary_dt_price, :volunteer_salary_dt_bonuses, :volunteer_salary_dt_overtime, :volunteer_salary_dt_total)",
            [
                ...
                'volunteer_salary_dt_overtime' => $params['volunteer_salary_dt_overtime'],
