...
class PurchaseOrderKitchenDt extends BaseModel
{
    ...
    public function insertData($params)
    {
        return DB::insert(
            ...
            (purchase_order_kitchen_id, purchase_order_kitchen_detail_description, purchase_order_kitchen_detail_qty,
            purchase_order_kitchen_detail_uom, purchase_order_kitchen_detail_price, purchase_order_kitchen_detail_total,
            purchase_order_kitchen_detail_send_date, upddate, upduser)
            VALUES
            (?, ?, ?, ?, ?, ?, ?, getdate(), ?)",
            [
                $params['purchase_order_kitchen_id'],
                $params['purchase_order_kitchen_detail_description'],
    ...
    public function getDataById($id)
    {
        return DB::select(
            ...
            a.purchase_order_kitchen_detail_description,
