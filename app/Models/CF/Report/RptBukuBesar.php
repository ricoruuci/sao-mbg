...
class RptBukuBesar extends BaseModel
{
    ...
    function getRptBukuBesar($param)
    {
        ...
        foreach ($result as $row) {
            ...
            $cekdata = DB::select(
                "SELECT k.transdate,k.voucherid,isnull(k.note,'') as keterangan,case when k.currid='idr' then k.amount else k.amount*k.rate end as amount,UPPER(k.jenis) as jenis,k.jenis as flagkkbb
                from (
                $addquery
                ) as k
